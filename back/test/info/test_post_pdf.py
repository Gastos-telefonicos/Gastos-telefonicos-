...
from script.body_base64 import *
import json
...
def test_should_return_phones_projects_and_costs():
    ...
    assert response_1.json == [{"phone": "747458001", "cost": "6,1322"}]

    response_2 = client.post("/api/docs", json=body_2, content_type="application/json")
    assert response_2.status_code == 200
    assert response_2.json == [{"phone": "605713419", "cost": "0,0000"}]
